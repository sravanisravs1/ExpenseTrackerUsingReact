...
function CompleteProfile(props) {
    ...
    async function getSavedData(){
        ...
        const res = await axios.post('https://identitytoolkit.googleapis.com/v1/accounts:lookup?key=AIzaSyDRorahRJ_juKatl8aQXmkip1wxxy28S84',{
            idToken: token,
          });
      console.log( res)
    ...
    const profileSubmitHandler = async (e) => {
       ...
       "https://identitytoolkit.googleapis.com/v1/accounts:update?key=AIzaSyDRorahRJ_juKatl8aQXmkip1wxxy28S84",
       {
         idToken: token,
